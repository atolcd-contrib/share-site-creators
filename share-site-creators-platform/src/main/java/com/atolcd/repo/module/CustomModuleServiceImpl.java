...
public class CustomModuleServiceImpl implements ApplicationContextAware, ModuleService {
  ...
  private static Log                  logger                              = LogFactory.getLog(CustomModuleServiceImpl.class);

  private ServiceRegistry             serviceRegistry;
  private CustomModuleComponentHelper moduleComponentHelper;
  ...
  public CustomModuleServiceImpl() {
    // DEBUT ATOLCD - Utilisation du CustomModuleCompoentHelper à la place de ModuleComponentHelper
    moduleComponentHelper = new CustomModuleComponentHelper();
    // FIN ATOLCD
